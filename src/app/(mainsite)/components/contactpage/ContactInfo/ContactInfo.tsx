    ...
    <div className={styles.info}>
        ...
        <div className={styles.info}>
            ...
            <div className={styles.textInfo}>
                ...
                <a className={styles.socialIcon} target='_blank' href={`https://www.facebook.com/profile.php?id=100070051958987`}>
                ...
                <a className={styles.socialIcon} target='_blank' href={`https://www.youtube.com/channel/UC2Fha3Ue7KzFSdR5SIl0t8g`}>
                ...
                <a className={styles.socialIcon} target='_blank' href={`https://www.instagram.com/apostleaaron603/`}>
